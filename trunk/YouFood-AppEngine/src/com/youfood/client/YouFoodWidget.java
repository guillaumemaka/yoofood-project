...
import com.youfood.client.MyRequestFactory.HelloWorldRequest;
import com.youfood.client.MyRequestFactory.MessageRequest;
import com.youfood.shared.MessageProxy;

public class YouFoodWidget extends Composite {
  ...
  interface YouFoodUiBinder extends UiBinder<Widget, YouFoodWidget> {
  }

  private static YouFoodUiBinder uiBinder = GWT.create(YouFoodUiBinder.class);
